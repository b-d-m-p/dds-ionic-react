...
export const PageList: React.FC = () => (
  <IonPage>
    <IonHeader>
      <IonToolbar>
        <IonTitle>An Opinionated Podcast App</IonTitle>
      </IonToolbar>
    </IonHeader>
    <IonContent>
      <IonItem>
        <IonLabel>
          <h2>Radio</h2>
          <p>
            Shows you want to listen to casually. Randomly played from new to
            old.
          </p>
        </IonLabel>
      </IonItem>
      <IonItem>
        <IonLabel>
          <h2>Focus</h2>
          <p>
            Shows that you don't want to miss. Randomly played from new to old.
          </p>
        </IonLabel>
      </IonItem>
      <IonItem>
        <IonLabel>
          <h2>Stories</h2>
          <p>Shows that are go in order. Randomly played from old to new.</p>
        </IonLabel>
      </IonItem>
      <IonItem>
        <IonLabel>
          <h2>Solo</h2>
          <p>A manual que of show to play in order, if that's how you roll.</p>
        </IonLabel>
      </IonItem>
      <IonItem>
        <IonLabel>
          <h2>Starred</h2>
          <p>Shows you starred.</p>
        </IonLabel>
      </IonItem>
      <IonItem>
        <IonLabel>
          <h2>All</h2>
          <p>A list of all your shows.</p>
        </IonLabel>
      </IonItem>
